...
# ─────────────────────────────────────────────────────────────────
# TECHNOLOGY DEFINITIONS (44 technologies from new matrix)
# ─────────────────────────────────────────────────────────────────
TECHNOLOGIES = [
    # Clean Energy Generation (1-9)
    "Solar PV",
    "Onshore Wind",
    "Offshore Wind (fixed foundation)",
    ...
    # Energy Storage & Grid (10-14)
    "Battery Storage (grid-scale)",
    "Long-Duration Energy Storage (LDES)",
    "Smart Grid & Grid Modernization",
    "HVDC Transmission",
    "Virtual Power Plants (VPP)",
    # Industrial Decarbonisation (15-21)
    "Low-carbon Steel & Cement",
    "Electric Arc Furnace (EAF)",
    "Green Aluminium",
    "Low-carbon Concrete",
    "Green Fertilizer (low-carbon NH3)",
    "Hydrogen-based Chemicals",
    "Industrial Heat Pumps (high-temp)",
    # Transport & Fuels (22-34)
    "Sustainable Aviation Fuel (SAF)",
    "HVO (Hydrotreated Vegetable Oil)",
    "E-kerosene (aviation e-fuel)",
    "E-Ammonia (maritime fuel)",
    "E-Methanol (maritime fuel)",
    "E-diesel / E-methanol (road & ship)",
    "Biogas (anaerobic digestion)",
    "Biomethane (upgraded to grid)",
    "Electric Vehicles (EVs)",
    "Hydrogen Fuel Cells (heavy-duty)",
    "Electric Aviation (eVTOL/short-haul)",
    "Rail Electrification",
    # Carbon Removal & Nature (35-40)
    ...
    # Circular Economy (42-43)
    "Advanced / Chemical Recycling",
    "Critical Minerals Processing (low-C)",
    # Digital (44)
    "Green Data Centers",
]

N = len(TECHNOLOGIES)  # 44
...
# MBM mechanism matrix: 'D'=Direct, 'I'=Indirect, None=not applicable
# Columns: ETS, Carbon Tax, Fuel Mandate, CfD, CCfD, CBAM, CORSIA, IMO Levy, VCM/CDM, AMC, Feebate
MBM_MATRIX = [
    # 1-9 Clean Energy Generation
    ('D','D',None,'D',None,'I',None,None,'D',None,None),   # Solar PV
    ('D','D',None,'D',None,None,None,None,'D',None,None),  # Onshore Wind
    ('D','D',None,'D',None,None,None,None,'D',None,None),  # Offshore Wind
    ('D','D',None,'D',None,None,None,None,'D',None,None),  # Float. Offshore
    ('D','D',None,'D',None,None,None,None,'D',None,None),  # CSP
    ('D','D',None,'D',None,None,None,None,'D',None,None),  # Ocean/Tidal
    ('D','D',None,'D',None,None,None,None,'I',None,None),  # SMR
    ('D','D',None,'D',None,None,None,None,'D',None,None),  # Geothermal EGS
    ('D','D','D','I','D','D',None,'D','D','D',None),       # Green H2
    # 10-14 Energy Storage & Grid
    ('D','D',None,'D',None,None,None,None,'D',None,None),  # Battery
    ('D','D',None,'D',None,None,None,None,'D',None,None),  # LDES
    ('I',None,None,None,None,None,None,None,'I',None,None),# Smart Grid
    ('I',None,None,None,None,None,None,None,None,None,None),# HVDC
    ('I',None,None,None,None,None,None,None,'I',None,None),# VPP
    # 15-21 Industrial
    ('D','D',None,None,'D','D',None,None,'D','D',None),    # Steel/Cement
    ('D','D',None,None,'D','D',None,None,'D','D',None),    # EAF
    ('D','D',None,None,'D','D',None,None,'D',None,None),   # Green Al
    ('D','D',None,None,'D','D',None,None,'D','D',None),    # Low-C Concrete
    ('D','D',None,None,'D','D',None,None,'D',None,None),   # Green NH3
    ('D','D',None,None,'D','D',None,None,'D',None,None),   # H2 Chem
    ('D','D',None,None,'D',None,None,None,'D',None,None),  # Ind. Heat Pump
    # 22-34 Transport
    ('D','D','D','D','D',None,'D',None,'D','D',None),      # SAF
    ('D','D','D',None,None,None,'D',None,'D',None,None),   # HVO
    ('D','D','D','D','D',None,'D',None,'D',None,None),     # E-kerosene
    ('D','D','D',None,'D','I',None,'D','D',None,None),     # E-Ammonia
    ('D','D','D',None,'D',None,None,'D','D',None,None),    # E-Methanol
    ('D','D','D',None,'D',None,None,'D','D',None,None),    # E-diesel
    ('D','D','D',None,None,None,None,None,'D',None,None),  # Biogas
    ('D','D','D',None,None,None,None,None,'D',None,None),  # Biomethane
    ('D','D',None,None,None,None,None,None,None,None,'D'), # EVs
    ('D','D',None,None,'D',None,None,None,'D',None,'D'),   # H2 Fuel Cell
    ('D','D',None,None,None,None,'D',None,'D',None,None),  # eVTOL
    ('D','D',None,None,None,None,None,None,'D',None,None), # Rail
    # 35-40 Carbon Removal
    ('D','D',None,None,'D',None,None,None,'D','D',None),   # CCUS
    ('D','D','D','D','D',None,None,None,'D','D',None),     # BECCS
    ('D','D','I',None,'D',None,None,None,'D','D',None),    # DAC
    ('D','D',None,None,'D',None,None,None,'D',None,None),  # W2E+CCS
    ('D','I',None,None,None,None,'D',None,'D',None,None),  # Reforestation
    (None,None,None,None,None,None,'D',None,'D',None,None),# Blue Carbon
    # 41 Building
    ('D','D',None,None,None,None,None,None,'D',None,None), # Bldg Efficiency
    # 42-43 Circular
    ('D','D',None,None,'D',None,None,None,'D',None,None),  # Chem Recycling
    ('D','D',None,None,None,'D',None,None,None,None,None), # Critical Minerals
    # 44 Digital
    ('D','D',None,None,None,None,None,None,'D',None,None), # Green Data Centers
]

# Helper: is mechanism active (D or I)?
def is_active(t, mech_idx):
    return MBM_MATRIX[t][mech_idx] is not None

def is_direct(t, mech_idx):
    return MBM_MATRIX[t][mech_idx] == 'D'

# MBM columns: 0=ETS, 1=Carbon Tax, 2=Fuel Mandate, 3=CfD, 4=CCfD, 5=CBAM, 6=CORSIA, 7=IMO Levy, 8=VCM/CDM, 9=AMC, 10=Feebate
...
# Estimated based on sector/technology characteristics
# ─────────────────────────────────────────────────────────────────
def make_defaults():
    # annual_output (MWh/yr or units/yr), installed_capacity (MW), capacity_factor,
    # project_lifetime (yr), capex_per_kw (USD/kW), opex_pct (fraction of CAPEX/yr),
    # feedstock_cost (USD/yr), other_opex (USD/yr), wacc,
    # market_price (USD/unit), co2_abated_factor (tCO2/unit),
    # learning_rate, cum_cap_now (GW), cum_cap_2035 (GW)
    d = {
        "annual_output":      [0]*N,
        "installed_capacity": [0]*N,
        "capacity_factor":    [0.0]*N,
        "project_lifetime":   [0]*N,
        "capex_per_kw":       [0]*N,
        "opex_pct":           [0.0]*N,
        "feedstock_cost":     [0]*N,
        "other_opex":         [0]*N,
        "wacc":               [0.0]*N,
        "market_price":       [0]*N,
        "co2_abated_factor":  [0.0]*N,
        "learning_rate":      [0.0]*N,
        "cum_cap_now":        [0.0]*N,
        "cum_cap_2035":       [0.0]*N,
    }
    vals = [
        # (output, cap_MW, cf, lt, capex/kw, opex%, feed$, other$, wacc, price, co2f, lr, cum_now, cum_2035)
        # --- Clean Energy Generation ---
        (500000, 200, 0.28, 25, 1100, 0.015, 0,        500000,  0.07, 65,    0.45, 0.20, 2000, 8000),   # Solar PV
        (450000, 200, 0.28, 25, 1400, 0.015, 0,        600000,  0.07, 65,    0.45, 0.15, 900,  4000),   # Onshore Wind
        (420000, 200, 0.40, 25, 3200, 0.020, 0,        1000000, 0.08, 80,    0.45, 0.12, 60,   500),    # Offshore Wind fixed
        (380000, 150, 0.40, 25, 4500, 0.025, 0,        1200000, 0.09, 85,    0.45, 0.10, 1,    50),     # Float Offshore
        (200000, 100, 0.40, 30, 5000, 0.020, 0,        800000,  0.08, 90,    0.45, 0.08, 5,    80),     # CSP
        (50000,  30,  0.35, 25, 8000, 0.030, 0,        500000,  0.09, 100,   0.45, 0.05, 0.2,  5),      # Ocean/Tidal/Wave
        (800000, 300, 0.90, 60, 8000, 0.025, 0,        2000000, 0.09, 80,    0.50, 0.04, 0.001,10),     # SMR
        (150000, 50,  0.90, 30, 6000, 0.030, 0,        700000,  0.08, 90,    0.45, 0.06, 0.01, 5),      # EGS
        (50000,  100, 0.45, 20, 2500, 0.025, 8000000,  2000000, 0.09, 4500,  0.90, 0.18, 0.5,  10),     # Green H2
        # --- Energy Storage & Grid ---
        (300000, 150, 0.25, 15, 1800, 0.020, 0,        800000,  0.08, 90,    0.30, 0.22, 1500, 5000),   # Battery grid
        (100000, 50,  0.30, 20, 3500, 0.025, 0,        600000,  0.09, 100,   0.30, 0.10, 0.1,  20),     # LDES
        (0,      0,   1.0,  20, 0,    0.050, 0,        2000000, 0.08, 0,     0.15, 0.08, 500,  2000),   # Smart Grid
        (0,      0,   1.0,  30, 0,    0.020, 0,        3000000, 0.08, 0,     0.10, 0.05, 10,   100),    # HVDC
        (0,      0,   1.0,  15, 0,    0.060, 0,        1500000, 0.08, 0,     0.15, 0.12, 50,   500),    # VPP
        # --- Industrial ---
        (250000, 50,  0.90, 25, 5000, 0.040, 5000000,  2000000, 0.10, 700,   0.80, 0.06, 0.1,  2),      # Steel/Cement
        (300000, 60,  0.90, 25, 4000, 0.035, 4000000,  1800000, 0.10, 650,   0.75, 0.08, 0.05, 1),      # EAF
        (150000, 40,  0.90, 25, 5500, 0.040, 3000000,  1500000, 0.10, 2500,  0.80, 0.07, 0.02, 0.5),    # Green Al
        (200000, 50,  0.90, 25, 4500, 0.040, 4000000,  1800000, 0.10, 600,   0.75, 0.07, 0.05, 1),      # Low-C Concrete
        (100000, 80,  0.90, 20, 3500, 0.030, 4000000,  1500000, 0.09, 950,   0.85, 0.10, 0.02, 0.5),    # Green NH3
        (80000,  60,  0.90, 20, 4000, 0.030, 3500000,  1200000, 0.09, 1200,  0.80, 0.09, 0.01, 0.3),    # H2 Chem
        (200000, 80,  0.85, 20, 2000, 0.025, 1000000,  800000,  0.08, 100,   0.40, 0.08, 0.1,  3),      # Ind. Heat Pump
        # --- Transport & Fuels ---
        (150000, 80,  0.85, 20, 3000, 0.030, 6000000,  1500000, 0.10, 2800,  0.70, 0.12, 0.05, 0.5),    # SAF
        (100000, 60,  0.85, 20, 2500, 0.028, 5000000,  1200000, 0.09, 1800,  0.65, 0.10, 0.02, 0.3),    # HVO
        (80000,  60,  0.85, 20, 4500, 0.035, 7000000,  1500000, 0.10, 3500,  0.75, 0.08, 0.005,0.1),    # E-kerosene
        (60000,  80,  0.90, 20, 3500, 0.030, 4000000,  1000000, 0.09, 950,   0.85, 0.10, 0.01, 0.2),    # E-Ammonia
        (50000,  60,  0.90, 20, 3200, 0.030, 3500000,  900000,  0.09, 1300,  0.75, 0.10, 0.01, 0.2),    # E-Methanol
        (60000,  60,  0.90, 20, 3000, 0.028, 3000000,  900000,  0.09, 1100,  0.70, 0.10, 0.01, 0.2),    # E-diesel
        (80000,  30,  0.85, 20, 2000, 0.028, 2000000,  700000,  0.08, 80,    0.60, 0.08, 10,   100),    # Biogas
        (100000, 40,  0.85, 20, 2500, 0.028, 2500000,  800000,  0.08, 90,    0.60, 0.08, 5,    50),     # Biomethane
        (0,      0,   1.0,  10, 0,    0.050, 0,        500000,  0.08, 0,     0.30, 0.22, 100,  1000),   # EVs
        (0,      0,   1.0,  15, 0,    0.060, 1000000,  800000,  0.09, 0,     0.50, 0.15, 0.1,  5),      # H2 Fuel Cell
        (0,      0,   1.0,  15, 0,    0.050, 0,        500000,  0.09, 0,     0.40, 0.18, 0.001,1),      # eVTOL
        (0,      0,   1.0,  40, 0,    0.020, 0,        2000000, 0.07, 0,     0.35, 0.05, 50,   200),    # Rail
        # --- Carbon Removal ---
        (100000, 50,  0.90, 30, 4000, 0.035, 2000000,  1000000, 0.10, 80,    0.85, 0.08, 0.03, 0.5),    # CCUS
        (120000, 60,  0.85, 25, 5000, 0.040, 3000000,  1500000, 0.09, 150,   0.90, 0.07, 0.01, 0.2),    # BECCS
        (50000,  25,  0.95, 20, 15000,0.050, 3000000,  2000000, 0.10, 500,   1.00, 0.15, 0.001,1),      # DAC
        (80000,  40,  0.85, 25, 4500, 0.040, 2000000,  1200000, 0.09, 100,   0.80, 0.07, 0.01, 0.2),    # W2E+CCS
        (80000,  0,   1.0,  30, 500,  0.100, 500000,   300000,  0.06, 12,    1.00, 0.05, 500,  1000),   # Reforestation
        (30000,  0,   1.0,  30, 300,  0.120, 200000,   100000,  0.06, 30,    1.00, 0.04, 10,   50),     # Blue Carbon
        # --- Building ---
        (400000, 0,   1.0,  20, 800,  0.050, 0,        1000000, 0.07, 100,   0.40, 0.08, 5000, 8000),   # Bldg Efficiency
        # --- Circular ---
        (100000, 30,  0.85, 20, 2000, 0.040, 2000000,  800000,  0.09, 200,   0.50, 0.10, 0.5,  10),     # Chem Recycling
        (50000,  20,  0.85, 20, 3000, 0.035, 1000000,  600000,  0.09, 500,   0.40, 0.08, 0.1,  2),      # Critical Minerals
        # --- Digital ---
        (200000, 50,  0.90, 10, 1500, 0.050, 0,        1500000, 0.08, 80,    0.20, 0.10, 50,   500),    # Green Data Centers
    ]

    for i, v in enumerate(vals):
        d["annual_output"][i]      = v[0]
        d["installed_capacity"][i] = v[1]
        d["capacity_factor"][i]    = v[2]
        d["project_lifetime"][i]   = v[3]
        d["capex_per_kw"][i]       = v[4]
        d["opex_pct"][i]           = v[5]
        d["feedstock_cost"][i]     = v[6]
        d["other_opex"][i]         = v[7]
        d["wacc"][i]               = v[8]
        d["market_price"][i]       = v[9]
        d["co2_abated_factor"][i]  = v[10]
        d["learning_rate"][i]      = v[11]
        d["cum_cap_now"][i]        = v[12]
        d["cum_cap_2035"][i]       = v[13]
...
# ─────────────────────────────────────────────────────────────────
# COUNTRY MBM PROFILES (from okookokok.xlsx)
# ─────────────────────────────────────────────────────────────────
COUNTRY_MBM = {
    "Australia":       {"region":"Australia & New Zealand","ets":21.8,"ctax":0,     "imo":0,"corsia":1,"cbam":0,"vcm_base":20},
    "New Zealand":     {"region":"Australia & New Zealand","ets":32.0,"ctax":0,     "imo":0,"corsia":1,"cbam":0,"vcm_base":25},
    "Austria":         {"region":"Western Europe",        "ets":70.4,"ctax":0,     "imo":1,"corsia":1,"cbam":1,"vcm_base":70},
    "Belgium":         {"region":"Western Europe",        "ets":70.4,"ctax":0,     "imo":1,"corsia":1,"cbam":1,"vcm_base":70},
    "France":          {"region":"Western Europe",        "ets":70.4,"ctax":48.1,  "imo":1,"corsia":1,"cbam":1,"vcm_base":70},
    "Germany":         {"region":"Western Europe",        "ets":70.4,"ctax":0,     "imo":1,"corsia":1,"cbam":1,"vcm_base":70},
    "Netherlands":     {"region":"Western Europe",        "ets":70.4,"ctax":94.8,  "imo":1,"corsia":1,"cbam":1,"vcm_base":80},
    "Switzerland":     {"region":"Western Europe",        "ets":64.7,"ctax":136.0, "imo":1,"corsia":1,"cbam":0,"vcm_base":80},
    "Liechtenstein":   {"region":"Western Europe",        "ets":0,   "ctax":136.0, "imo":0,"corsia":1,"cbam":0,"vcm_base":80},
    "Luxembourg":      {"region":"Western Europe",        "ets":70.4,"ctax":58.5,  "imo":1,"corsia":1,"cbam":1,"vcm_base":70},
    "Denmark":         {"region":"Northern Europe",       "ets":70.4,"ctax":108.4, "imo":1,"corsia":1,"cbam":1,"vcm_base":80},
    "Finland":         {"region":"Northern Europe",       "ets":70.4,"ctax":66.9,  "imo":1,"corsia":1,"cbam":1,"vcm_base":80},
    "Norway":          {"region":"Northern Europe",       "ets":0,   "ctax":133.9, "imo":1,"corsia":1,"cbam":0,"vcm_base":90},
    "Sweden":          {"region":"Northern Europe",       "ets":70.4,"ctax":144.6, "imo":1,"corsia":1,"cbam":1,"vcm_base":90},
    "Iceland":         {"region":"Northern Europe",       "ets":0,   "ctax":60.1,  "imo":1,"corsia":1,"cbam":0,"vcm_base":60},
    "Lithuania":       {"region":"Northern Europe",       "ets":70.4,"ctax":0,     "imo":1,"corsia":1,"cbam":1,"vcm_base":60},
    "Latvia":          {"region":"Northern Europe",       "ets":70.4,"ctax":16.2,  "imo":1,"corsia":1,"cbam":1,"vcm_base":60},
    "Estonia":         {"region":"Northern Europe",       "ets":70.4,"ctax":27.0,  "imo":1,"corsia":1,"cbam":1,"vcm_base":60},
    "United Kingdom":  {"region":"Northern Europe",       "ets":57.2,"ctax":23.2,  "imo":1,"corsia":1,"cbam":0,"vcm_base":70},
    "Spain":           {"region":"Southern Europe",       "ets":70.4,"ctax":16.2,  "imo":1,"corsia":1,"cbam":1,"vcm_base":65},
    "Italy":           {"region":"Southern Europe",       "ets":70.4,"ctax":0,     "imo":1,"corsia":1,"cbam":1,"vcm_base":65},
    "Portugal":        {"region":"Southern Europe",       "ets":70.4,"ctax":72.7,  "imo":1,"corsia":1,"cbam":1,"vcm_base":65},
    "Greece":          {"region":"Southern Europe",       "ets":70.4,"ctax":0,     "imo":1,"corsia":1,"cbam":1,"vcm_base":60},
    "Slovenia":        {"region":"Southern Europe",       "ets":70.4,"ctax":33.3,  "imo":1,"corsia":1,"cbam":1,"vcm_base":60},
    "Malta":           {"region":"Southern Europe",       "ets":70.4,"ctax":0,     "imo":1,"corsia":1,"cbam":1,"vcm_base":60},
    "Montenegro":      {"region":"Southern Europe",       "ets":25.9,"ctax":0,     "imo":0,"corsia":0,"cbam":0,"vcm_base":20},
    "Andorra":         {"region":"Southern Europe",       "ets":0,   "ctax":32.4,  "imo":0,"corsia":0,"cbam":0,"vcm_base":25},
    "Cyprus":          {"region":"Southern Europe",       "ets":70.4,"ctax":0,     "imo":1,"corsia":1,"cbam":1,"vcm_base":60},
    "Poland":          {"region":"Eastern Europe",        "ets":70.4,"ctax":0.1,   "imo":1,"corsia":1,"cbam":1,"vcm_base":60},
    "Czech Republic":  {"region":"Eastern Europe",        "ets":70.4,"ctax":0,     "imo":1,"corsia":1,"cbam":1,"vcm_base":55},
    "Romania":         {"region":"Eastern Europe",        "ets":70.4,"ctax":0,     "imo":1,"corsia":1,"cbam":1,"vcm_base":55},
    "Slovakia":        {"region":"Eastern Europe",        "ets":70.4,"ctax":0,     "imo":1,"corsia":1,"cbam":1,"vcm_base":55},
    "Hungary":         {"region":"Eastern Europe",        "ets":70.4,"ctax":38.8,  "imo":1,"corsia":1,"cbam":1,"vcm_base":55},
    "Bulgaria":        {"region":"Eastern Europe",        "ets":70.4,"ctax":0,     "imo":1,"corsia":1,"cbam":1,"vcm_base":55},
    "Ukraine":         {"region":"Eastern Europe",        "ets":0,   "ctax":0.7,   "imo":0,"corsia":0,"cbam":0,"vcm_base":5},
    "Albania":         {"region":"Eastern Europe",        "ets":0,   "ctax":13.7,  "imo":0,"corsia":0,"cbam":0,"vcm_base":10},
    "Canada":          {"region":"North America",         "ets":66.2,"ctax":0,     "imo":0,"corsia":1,"cbam":0,"vcm_base":25},
    "United States":   {"region":"North America",         "ets":50.0,"ctax":0,     "imo":0,"corsia":0,"cbam":0,"vcm_base":20},
    "Mexico":          {"region":"Central America",       "ets":0,   "ctax":27.8,  "imo":0,"corsia":1,"cbam":0,"vcm_base":8},
    "Colombia":        {"region":"South America",         "ets":0,   "ctax":6.5,   "imo":0,"corsia":1,"cbam":0,"vcm_base":8},
    "Chile":           {"region":"South America",         "ets":0,   "ctax":5.0,   "imo":0,"corsia":0,"cbam":0,"vcm_base":8},
    "Argentina":       {"region":"South America",         "ets":0,   "ctax":5.3,   "imo":0,"corsia":1,"cbam":0,"vcm_base":8},
    "Uruguay":         {"region":"South America",         "ets":0,   "ctax":158.8, "imo":0,"corsia":1,"cbam":0,"vcm_base":15},
    "Brazil":          {"region":"South America",         "ets":0,   "ctax":5.0,   "imo":0,"corsia":1,"cbam":0,"vcm_base":8},
    "China":           {"region":"East Asia",             "ets":11.8,"ctax":0,     "imo":1,"corsia":0,"cbam":0,"vcm_base":5},
    "Japan":           {"region":"East Asia",             "ets":4.0, "ctax":1.9,   "imo":1,"corsia":1,"cbam":0,"vcm_base":30},
    "South Korea":     {"region":"East Asia",             "ets":6.5, "ctax":0,     "imo":1,"corsia":1,"cbam":0,"vcm_base":15},
    "Kazakhstan":      {"region":"Central Asia",          "ets":0.9, "ctax":0,     "imo":0,"corsia":0,"cbam":0,"vcm_base":3},
    "Singapore":       {"region":"Southeast Asia",        "ets":0,   "ctax":18.6,  "imo":1,"corsia":1,"cbam":0,"vcm_base":20},
    "Indonesia":       {"region":"Southeast Asia",        "ets":0.7, "ctax":0,     "imo":0,"corsia":1,"cbam":0,"vcm_base":5},
    "India":           {"region":"South Asia",            "ets":0,   "ctax":0,     "imo":0,"corsia":1,"cbam":0,"vcm_base":5},
    "Israel":          {"region":"West Asia (Middle East)","ets":0,  "ctax":1.5,   "imo":1,"corsia":1,"cbam":0,"vcm_base":10},
    "UAE":             {"region":"West Asia (Middle East)","ets":0,  "ctax":0,     "imo":1,"corsia":1,"cbam":0,"vcm_base":8},
    "Saudi Arabia":    {"region":"West Asia (Middle East)","ets":0,  "ctax":0,     "imo":1,"corsia":0,"cbam":0,"vcm_base":5},
    "South Africa":    {"region":"Southern Africa",       "ets":0,   "ctax":12.8,  "imo":0,"corsia":1,"cbam":0,"vcm_base":10},
    "Kenya":           {"region":"East Africa",           "ets":0,   "ctax":0,     "imo":0,"corsia":1,"cbam":0,"vcm_base":8},
    "Nigeria":         {"region":"West Africa",           "ets":0,   "ctax":0,     "imo":0,"corsia":1,"cbam":0,"vcm_base":5},
}

ALL_REGIONS = sorted(set(v["region"] for v in COUNTRY_MBM.values()))
...
def compute(prices, t, ti):
    ...
    ck  = ti["installed_capacity"][t] * 1000  # kW
    ...
    # MBM columns: 0=ETS, 1=CtaX, 2=Fuel, 3=CfD, 4=CCfD, 5=CBAM, 6=CORSIA, 7=IMO, 8=VCM, 9=AMC, 10=Feebate
    def active(mech_idx, require_direct=False):
        v = MBM_MATRIX[t][mech_idx]
        if require_direct:
            return v == 'D'
    ...
    cf = (o * max(0, prices["cfd_strike"] - prices["cfd_ref"]) * 0.5
          if active(3) and o > 0 else 0)
    ccf= (co2 * max(0, prices["ccfd_strike"] - prices["ccfd_ref"]) * 0.5
          if active(4) and co2 > 0 else 0)
    ...
    return {
        "tc": tc, "ac": ac, "fo": fo, "co2": co2,
        "dr": dr, "mb": mb, "tr": tr,
        "nc": tr - tc, "lr": tr * lt,
        "rc": tr / tc if tc > 0 else 0,
        "bd": {"ETS": e, "Carbon Tax": cx, "Fuel Mandate": fu, "CfD": cf, "CCfD": ccf,
               "CBAM": cb, "CORSIA": co, "IMO Levy": im, "VCM/CDM": v, "AMC": am, "Feebate": fb},
    }

def compute_country(country_mbm_profile, base_prices, t, ti):
    """Compute with country-specific ETS/carbon tax overrides."""
    cp = dict(base_prices)
    cp["ets"]  = country_mbm_profile["ets"]
    cp["ctax"] = country_mbm_profile["ctax"]
    cp["vcm"]  = country_mbm_profile.get("vcm_base", base_prices["vcm"])
    # IMO and CORSIA: binary applicable flag scales the base price
    if not country_mbm_profile.get("imo", 0):
        cp["imo"] = 0
    if not country_mbm_profile.get("corsia", 0):
        cp["corsia"] = 0
    # CBAM only applies in EU-CBAM jurisdictions
    if not country_mbm_profile.get("cbam", 0):
        cp["cbam"] = 0
...
with st.sidebar:
    ...
    <div style="padding:14px 18px 5px;font-size:0.6rem;color:#cbd5e1;font-weight:700;text-transform:uppercase;letter-spacing:0.12em;">
        Main Menu
    </div>
    """, unsafe_allow_html=True)
...
if page == "Portfolio Overview":
    ...
    with col_l:
        ...
        fig.add_trace(go.Bar(name="MBM Revenue",    x=[TECH_SHORT[i] for i in srt],
            y=[AR[i]["mb"]/1e6 for i in srt], marker_color="#059669"))
        fig.add_trace(go.Bar(name="Direct Revenue", x=[TECH_SHORT[i] for i in srt],
            y=[AR[i]["dr"]/1e6 for i in srt], marker_color="#34d399"))
        fig.add_trace(go.Bar(name="Cost",           x=[TECH_SHORT[i] for i in srt],
            y=[-AR[i]["tc"]/1e6 for i in srt], marker_color="#dcfce7"))
    ...
    fig3 = go.Figure(go.Bar(x=TECH_SHORT, y=nv,
        ...
        text=[f"${v:.1f}M" for v in nv], textposition="outside",
    ...
    # Stacked MBM
    st.markdown('<div class="sec-head">MBM Policy Intervention — Stacked Revenue & Direct vs MBM</div>', unsafe_allow_html=True)
...
# ═════════════════════════════════════════════════════════════════
    ...
    if cat_sel == "All":
        ...
        avail = [i for i,c in enumerate(TECH_CATEGORIES) if c == cat_sel]
    ...
    with cb:
        ...
        vals_ = [r["dr"]/1e6, r["mb"]/1e6, -r["ac"]/1e6, -r["fo"]/1e6,
                 -ti["feedstock_cost"][t]/1e6, -ti["other_opex"][t]/1e6]
        fw = go.Figure(go.Bar(x=cats_, y=vals_,
            marker_color=["#059669" if v >= 0 else "#fca5a5" for v in vals_],
            text=[f"${abs(v):.2f}M" for v in vals_],
            textposition="outside", textfont=dict(size=9, color=FC)))
    ...
    mech_idxs = list(range(11))
    html = ""
    for mi, mk in zip(mech_idxs, mech_keys):
        lbl = MBM_LABELS[mk][0]
        val = MBM_MATRIX[t][mi]
        if val == 'D':
            html += f'<span class="chip chip-d">✓ {lbl} (Direct)</span>'
        elif val == 'I':
            html += f'<span class="chip chip-i">~ {lbl} (Indirect)</span>'
        else:
            html += f'<span class="chip chip-off">✕ {lbl}</span>'
...
# ═════════════════════════════════════════════════════════════════
    ...
    with sc1:
        el = st.slider("ETS Low",    10, 200, 30,       10)
    ...
    with sc3:
        cl_v = st.slider("CTax Low",  0, 100, 20, 5)
        cb_v = st.slider("CTax Base", 0, 200, bp["ctax"], 5)
        ch_v = st.slider("CTax High", 20, 300, 150, 5)

    scens = {
        "Low":  {**bp, "ets": el,  "vcm": vl,  "ctax": cl_v},
        "Base": {**bp, "ets": eb,  "vcm": vb,  "ctax": cb_v},
        "High": {**bp, "ets": eh,  "vcm": vh,  "ctax": ch_v},
    }
    sr = {}
    for sn, sp in scens.items():
        res = [compute(sp, i, st.session_state.ti) for i in range(N)]
    ...
    st.markdown("<div style='height:12px'></div>", unsafe_allow_html=True)
    fsc = go.Figure()
    colors_ = {"Total Revenue":"#059669","MBM Revenue":"#064e3b","Net Cash Flow":"#34d399"}
    for m, lbl in [("tr","Total Revenue"),("mb","MBM Revenue"),("nc","Net Cash Flow")]:
        fsc.add_trace(go.Bar(name=lbl, x=list(sr.keys()), y=[sr[s][m]/1e6 for s in sr],
                             marker_color=colors_[lbl]))
...
# ═════════════════════════════════════════════════════════════════
    ...
    <div class="page-header">
        ...
        <div class="page-header-sub">Complete revenue summary, MBM breakdown, and applicability matrix — 44 technologies · 11 mechanisms</div>
    </div>''', unsafe_allow_html=True)
    ...
    with t1:
        ...
        st.dataframe(df.style.bar(subset=["Total Rev ($M)","Net CF ($M)"], color="#bbf7d0"),
                     use_container_width=True, height=600)
        st.download_button("⬇ Download CSV", df.to_csv(index=False).encode(), "revenue_summary.csv", "text/csv")

    with t2:
        mbrows = []
        for i, r in enumerate(AR):
            row = {"Technology": TECH_SHORT[i], "Category": TECH_CATEGORIES[i]}
            for k, v in r["bd"].items(): row[f"{k} ($M)"] = round(v/1e6, 2)
            row["Total MBM ($M)"] = round(r["mb"]/1e6, 2)
            mbrows.append(row)
        dfm = pd.DataFrame(mbrows)
        st.dataframe(dfm.style.bar(subset=["Total MBM ($M)"], color="#bbf7d0"),
                     use_container_width=True, height=600)
        st.download_button("⬇ Download CSV", dfm.to_csv(index=False).encode(), "mbm_breakdown.csv", "text/csv")

    with t3:
        mech_cols = ["ETS","Carbon Tax","Fuel Mandate","CfD","CCfD","CBAM","CORSIA","IMO Levy","VCM/CDM","AMC","Feebate"]
        # Encode: 2=Direct, 1=Indirect, 0=None
        z = []
        texts_z = []
        for i in range(N):
            row_z, row_t = [], []
            ...
            z.append(row_z)
            texts_z.append(row_t)

        fhm = go.Figure(go.Heatmap(
            z=z, x=mech_cols, y=TECH_SHORT,
...
# ═════════════════════════════════════════════════════════════════
    ...
    items = [
        ...
        ("CCfD Strike",         p["ccfd_strike"], "USD/tCO₂e"),
        ("CCfD Reference",      p["ccfd_ref"],    "USD/tCO₂e"),
...
# ═════════════════════════════════════════════════════════════════
    ...
    for i in range(N):
        ...
        npv_rows.append({
            ...
            "NPV with MBM ($M)": round(npv_m/1e6, 1),
            "NPV no MBM ($M)":   round(npv_n/1e6, 1),
...
# ═════════════════════════════════════════════════════════════════
    ...
    ck  = ti["installed_capacity"][t_tc]*1000
...
# ═════════════════════════════════════════════════════════════════
    ...
    st.markdown('''
    <div class="page-header">
        <div class="page-header-badge">Geospatial Analysis · Real Country Data</div>
        <div class="page-header-title">🌍 Spatial Viability</div>
        <div class="page-header-sub">Technology viability across 57 countries — ETS & Carbon Tax prices from live database (okookokok.xlsx)</div>
    </div>''', unsafe_allow_html=True)
    ...
    📌 <b>Data source:</b> ETS and Carbon Tax prices are drawn directly from the country price database (okookokok.xlsx).
    VCM, IMO, CORSIA, and CBAM applicability are based on jurisdiction-level policy flags.
    </div>""", unsafe_allow_html=True)
    ...
    with sv3:
        ...
        show_regions  = st.multiselect("Filter Regions", ALL_REGIONS, default=ALL_REGIONS, key="sv_region")
    ...
    for country, cmbm in COUNTRY_MBM.items():
        if cmbm["region"] not in show_regions:
            continue
        r_sv = compute_country(cmbm, st.session_state.p, t_sv, ti)
        ...
        sv_rows.append({
            ...
            "Region":          cmbm["region"],
            "ETS ($/tCO₂e)":   cmbm["ets"],
            "Carbon Tax ($/tCO₂e)": cmbm["ctax"],
            "VCM Base":        cmbm.get("vcm_base", 0),
            "IMO":             "✓" if cmbm.get("imo") else "—",
            "CORSIA":          "✓" if cmbm.get("corsia") else "—",
            "CBAM":            "✓" if cmbm.get("cbam") else "—",
    ...
    _metric_col = viab_metric
    df_sv = pd.DataFrame(sv_rows).sort_values(_metric_col, ascending=False).reset_index(drop=True)
    ...
    colors_sv = ["#059669" if v>=0 else "#fca5a5" for v in df_sv[_metric_col]]
    fig_sv = go.Figure(go.Bar(
        x=df_sv["Country"], y=df_sv[_metric_col],
        marker_color=colors_sv,
        text=[f"{v:.1f}" for v in df_sv[_metric_col]],
        textposition="outside", textfont=dict(size=8, color=FC),
    ))
    fig_sv.add_hline(y=0, line_color="#e2e8f0", line_width=1.5)
    fig_sv.update_layout(**pl(380, mb=90))
    fig_sv.update_layout(xaxis=dict(tickangle=-45), yaxis_title=viab_metric,
        title=dict(text=f"{sel_sv} — {viab_metric} by Country", font=dict(size=11,color=FC), y=0.98))
    st.plotly_chart(fig_sv, use_container_width=True)

    # MBM decomposition by country
    ...
    ets_vals, ctax_vals, vcm_vals, imo_vals, other_vals = [], [], [], [], []
    for country in countries_list:
        cmbm = COUNTRY_MBM[country]
        r2   = compute_country(cmbm, st.session_state.p, t_sv, ti)
        ets_vals.append(r2["bd"].get("ETS",0)/1e6)
        ctax_vals.append(r2["bd"].get("Carbon Tax",0)/1e6)
        vcm_vals.append(r2["bd"].get("VCM/CDM",0)/1e6)
        imo_vals.append(r2["bd"].get("IMO Levy",0)/1e6)
        other_v = max(0, r2["mb"]/1e6 - r2["bd"].get("ETS",0)/1e6
                       - r2["bd"].get("Carbon Tax",0)/1e6 - r2["bd"].get("VCM/CDM",0)/1e6
                       - r2["bd"].get("IMO Levy",0)/1e6)
        other_vals.append(other_v)

    fig_mbm_c = go.Figure()
    fig_mbm_c.add_trace(go.Bar(name="ETS",        x=countries_list, y=ets_vals,   marker_color="#065f46"))
    fig_mbm_c.add_trace(go.Bar(name="Carbon Tax", x=countries_list, y=ctax_vals,  marker_color="#059669"))
    fig_mbm_c.add_trace(go.Bar(name="VCM/CDM",    x=countries_list, y=vcm_vals,   marker_color="#34d399"))
    fig_mbm_c.add_trace(go.Bar(name="IMO Levy",   x=countries_list, y=imo_vals,   marker_color="#6ee7b7"))
    fig_mbm_c.add_trace(go.Bar(name="Other MBMs", x=countries_list, y=other_vals, marker_color="#a7f3d0"))
    ...
    # Heatmap of carbon prices
    st.markdown('<div class="sec-head">Carbon Price Heatmap by Country (Real Data)</div>', unsafe_allow_html=True)
    # Only show countries with at least one non-zero price for clarity
    df_nz = df_sv[(df_sv["ETS ($/tCO₂e)"] > 0) | (df_sv["Carbon Tax ($/tCO₂e)"] > 0)].copy()
    if len(df_nz) > 0:
        fig_heat = go.Figure(go.Heatmap(
            z=[[COUNTRY_MBM[c]["ets"], COUNTRY_MBM[c]["ctax"], COUNTRY_MBM[c].get("vcm_base",0)]
               for c in df_nz["Country"]],
            x=["ETS ($/tCO₂e)","Carbon Tax ($/tCO₂e)","VCM Base ($/tCO₂e)"],
            y=df_nz["Country"].tolist(),
        ...
        fig_heat.update_layout(**pl(max(400, len(df_nz)*18), ml=140, mr=60, mt=20, mb=30))
        st.plotly_chart(fig_heat, use_container_width=True)
    else:
        st.info("No countries with carbon price data visible in current filter.")

    # Full data table
    st.markdown('<div class="sec-head">Full Country Data Table</div>', unsafe_allow_html=True)
    st.dataframe(df_sv.style.bar(subset=["NPV ($M)","Net CF ($M)","MBM Rev ($M)"], color="#bbf7d0", align="mid"),
                 use_container_width=True, height=600)
    st.download_button("⬇ Download Spatial Viability CSV", df_sv.to_csv(index=False).encode(),
